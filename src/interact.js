        ...
        input = <div className='flex justify-center'>
            ...
            <button className='border border-black hover:bg-red-300 bg-blue-500 h-12 w-2/6 mt-5 ml-1 px-2 rounded-lg' onClick={(event) => {
                ...
                async function runAItext() {
                    ...
                    try {
                        const response = await fetch("https://api.openai.com/v1/answers", {
                            body: `{"documents": ["My name is Freya.", "I bought 1.005 USDC on october 21", "I bought USDC" ,"I aped into USDC", "traded 1 WBUSD for 1.005 USDC", "1 wrapped BUSD for 1.005 USDC", "wrapped BUSD for USDC", "I will buy wrapped BUSD next", "My creator is Autonomy Network", "Next I will buy wrapped BUSD"],"question": "${question}","search_model": "ada","model": "curie","examples_context": "Adeolu is a developer.","examples": [["What is your name?","Freya."], ["What did you buy?", "1.005"], ["When did you buy?","today."], ["What did you ape into?", "USDC."], ["What was your last trade?", "I traded 1 wrapped BUSD for 1.005 USDC"], ["What did you trade?", "wrapped BUSD for USDC"], ["What was traded", "1 wrapped BUSD for 1.005 USDC"], ["What did you last buy?", "USDC"], ["What will you buy next?", "Wrapped BUSD"], ["What is next?", "Buying Wrapped BUSD"]],"max_tokens":15,"stop": ["n", "<|endoftext|>"]}`,
                            headers: {
                                Authorization: "Bearer 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",
                                "Content-Type": "application/json"
                            },
